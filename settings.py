...
GOOGLE_ATTENDEE_EMAIL = os.getenv("GOOGLE_ATTENDEE_EMAIL", None)
...
WITH_BREAK = os.getenv("WITH_BREAK", "True") == "True"
BREAK_TIME = os.getenv("BREAK_TIME", 30)
BREAK_AFTER = os.getenv("BREAK_AFTER", 13)

# ALGORITHM PARAMETERS
TIME_PER_ESTIMATION_POINT = os.getenv("TIME_PER_ESTIMATION_POINT", None)
MIN_CONSIDERABLE_SLOT_TIME = os.getenv("MIN_CONSIDERABLE_SLOT_TIME", 0)
ALGORITHM = os.getenv("ALGORITHM", "NAIVE_GREEDY_WITH_SPLIT")  # NAIVE_GREEDY, NAIVE_GREEDY_WITH_SPLIT


# OPTIMISE_FOCUS_TIME PARAMETERS
FOCUS_TIME_CALENDAR_START = os.getenv("FOCUS_TIME_CALENDAR_START")
FOCUS_TIME_CALENDAR_END = os.getenv("FOCUS_TIME_CALENDAR_END")
FOCUS_TIME_STORY_POINTS_CAPACITY = os.getenv("FOCUS_TIME_STORY_POINTS_CAPACITY")
