...
class CalendarPlannerAlgorithm:
    ...
    def scheduled_sprint_coverage(self):
        return self.expected_time_to_finish_scheduled_issues / (
    ...
    def print_stats(self):
        ...
        print_issues(
            self.issues.in_prioritised_order,
            time_per_estimation_point=self.expected_time_per_estimation_point,
        )

        print("\n\n")
        print("Not scheduled issues:\n")
        print_issues(
            self.not_scheduled_issues,
            time_per_estimation_point=self.expected_time_per_estimation_point,
        )
